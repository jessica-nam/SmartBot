...
### NOTE: Re-compile this file after updating database ###
import nltk
...
def model():
    """ Generate training data and machine learning model"""
    ...
    for intent in intents['intents']:
        for pattern in intent['patterns']:
            ...
            documents.append((w, intent['tag'])) # Tags are the different categories
    ...
    hist = model.fit(np.array(train_x), np.array(train_y), epochs=3000, batch_size=32, verbose=1)
